...
asfis <- read_csv(paste0("/Users/maxlindmark/atlas-data", "/ASFIS_sp_2021.csv")) 
swe_sp <- read_delim(paste0("/Users/maxlindmark/atlas-data", "/latin_swedish_names.csv")) 
...
preCL <- preCL |> 
  mutate(
    ...
    Bestånd = ifelse(FNAMNSVE == "Nordhavsräka" & SUB_REGION %in% c("27.3.a.20", "27.3.a.21", "27.4.a"), #FIXME: 4a east? same as 27.4.a?
                     "pra.27.3a4a", Bestånd),
    Bestånd = ifelse(FNAMNSVE == "Rödspätta" & SUB_REGION %in% c("27.3.a.21", "27.3.c.22", "27.3.b.23"), 
                     "ple.27.21-23", Bestånd),
    Bestånd = ifelse(FNAMNSVE == "Rödspätta" & SUB_REGION %in% c("27.3.d.24", "27.3.d.25", "27.3.d.26", "27.3.d.27", "27.3.d.28.2", "27.3.d.29", "27.3.d.30", "27.3.d.31", "27.3.d.32"), 
    ...
    Bestånd = ifelse(FNAMNSVE == "Skarpsill" & SUB_REGION %in% c("27.3.a.20", "27.3.a.21", "27.4.a", "27.4.b", "27.4.c"), 
                     "spr.27.3a4", Bestånd),
    Bestånd = ifelse(FNAMNSVE == "Tobisfiskar" & SUB_REGION %in% c("27.3.a.20", "27.3.a.21", "27.4.a", "27.4.b", "27.4.c"), 
...
preCL <- preCL |> 
  mutate(fishery = ifelse(Bestånd %in% c("sol.27.20-24", "ple.27.21-23") &
...
write_xlsx(preCL_sum, paste0(home, "/output/2025/HaV/table1.xlsx"))
```
