...
# https://stockdatabase.ices.dk/default.aspx
  ...
  mutate(
    ...
    Bestånd = ifelse(FNAMNSVE == "Nordhavsräka" & SUB_REGION %in% c("27.3.a.20", "27.3.a.21", "27.4.a"), #FIXME: 4a east? same as 27.4.a?
                     "pra.27.3a4a", Bestånd),
    Bestånd = ifelse(FNAMNSVE == "Kolja" & SUB_REGION %in% c("27.4.a", "27.4.b", "27.4.c", "27.6.a"), #FIXME: 4a east? same as 27.4.a?
...
write_xlsx(target_sp_df, paste0(home, "/_daniel/output/table1.xlsx"))
```
...
write_xlsx(stock_target_sub_df, paste0(home, "/_daniel/output/table2.xlsx"))
```
...
write_xlsx(fleet, paste0(home, "/_daniel/output/table3.xlsx"))
```
...
write_xlsx(value_fishery, paste0(home, "/_daniel/output/table4.xlsx"))
```
