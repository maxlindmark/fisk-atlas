...
load("/Users/maxlindmark/atlas-data//lovgren_foCatFA_2003_2024_20250825.RData")
...
shape <- shapefile(paste0("/Users/maxlindmark/Dropbox/Max work/R/pred-prey-overlap",
                          "/data/shapefiles/ICES-StatRec-mapto-ICES-Areas/StatRec_map_Areas_Full_20170124.shp"))
...
write_xlsx(target_sp_df, paste0(home, "/output/2025/ERA/table1.xlsx"))
```
...
write_xlsx(stock_target_sub_df, paste0(home, "/output/2025/ERA/table2.xlsx"))
```

# 3. Antal aktiva fartyg i varje fiske per år de senaste tre åren (2022, 2023 och 2024)

```{r}
#| message: false
#| results: asis

# TODO: what should the cutoff be? Here I remove vessels that appear less than 10 times since 2022
...
write_xlsx(fleet, paste0(home, "/output/2025/ERA/table3.xlsx"))
```

# 4. Totalt landningsvärde per fiske per år de senaste tre åren (2022, 2023 och 2024)
...
exchange <- read_csv("/Users/maxlindmark/atlas-data/ECB Data Portal_20250826200550.csv") |>
  janitor::clean_names() |>
...
write_xlsx(value_fishery, paste0(home, "/output/2025/ERA/table4.xlsx"))
```
